...
export default function GameCard({
  ...
  return (
    <Card
      isFooterBlurred
      isPressable
      className={`border-1.5 ${border} transition-all duration-300 ease-in-out hover:scale-[1.02] hover:shadow-2xl ${shadow} overflow-visible`}
      radius="lg"
    >
      <Image className="object-cover" src={imageUrl} />
      <div className="w-8 h-8 absolute z-10 -translate-x-1/5 -translate-y-1/5">
        <Elixir cost={elixir} />
      </div>
